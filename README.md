...
This will cause the function to fail when you run your code with the following error: `/opt/homebrew/Cellar/azure-functions-core-tools@4/YOUR_AZURE_FUNCTION_CORE_TOOLS_VERSION/workers/python/3.9/OSX/Arm64/worker.py does not exist`. If that folder is missing, create a symlink:
```console
